...
async def generate_session(bot: Client, msg: Message, telethon=False, is_bot: bool = False):
    ...
    if not is_bot:
        await msg.reply("Ngirim OTP...")
    else:
        await msg.reply("Bentar Nyet...")
    ...
    text = f"**{ty.upper()} Nih Nyet** \n\n`{string_session}` \n\nGenerated by @KynanSupport"
    try:
        if not is_bot:
